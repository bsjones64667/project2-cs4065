...
- `%join`
    - Syntax: `%join`
    - Description: This command is used to join the single message board.
...
- `%groupjoin`
    - Syntax: `%groupjoin [group_id/name]`
    - Description: This command is used to join a specific group. The command is followed by the group id/name. This command uses BBP/2 only.

- `%grouppost`
    - Syntax: `%grouppost [group_id/name] [message_subject] [message_content]`
...
- `%groupusers`
    - Syntax: `%groupusers [group_id/name]`
